...
RUNTIME_BUILD = "2026-09-19.14-cache-rootfix"
...
if st.session_state.get("results") is None and DATABASE_URL:
    try:
        ...
        if isinstance(restored, dict) and isinstance(restored.get("results"), list):
            ...
            if "ordinary-v2-cache-rootfix-20260919-11" in restored_signature:
...
if run:
    ...
    try:
        ...
        ANALYSIS_ENGINE_VERSION = "ordinary-v2-cache-rootfix-20260919-11"
...
if st.session_state.get("results") is not None:
    ...
    if not _advanced_terminal:
        ...
        if _main_view == "Vad ska jag köpa?":
            ...
            price_funnel = (st.session_state.get("debug") or {}).get("price_research_funnel") or {}
            if price_funnel:
