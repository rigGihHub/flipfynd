...
RUNTIME_BUILD = "2026-09-19.25-market-gap-first"
...
if st.session_state.get("results") is None and DATABASE_URL:
    try:
        ...
        if isinstance(restored, dict) and isinstance(restored.get("results"), list):
            ...
            if "ordinary-v2-market-gap-first-20260919-22" in restored_signature:
...
if run:
    ...
    try:
        ...
        ANALYSIS_ENGINE_VERSION = "ordinary-v2-market-gap-first-20260919-22"
