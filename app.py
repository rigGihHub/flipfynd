...
RUNTIME_BUILD = "2026-09-19.22-price-routing-fix"
...
if st.session_state.get("results") is None and DATABASE_URL:
    try:
        ...
        if isinstance(restored, dict) and isinstance(restored.get("results"), list):
            ...
            if "ordinary-v2-price-routing-fix-20260919-19" in restored_signature:
...
if run:
    ...
    try:
        ...
        ANALYSIS_ENGINE_VERSION = "ordinary-v2-price-routing-fix-20260919-19"
