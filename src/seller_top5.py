...
def _fallback_row(qrow: dict, alias: str) -> dict:
    ...
    return {
        ...
        "net_profit_estimate": qrow.get("net_profit_estimate"),
        "valuation_display_safe": qrow.get("valuation_display_safe") is True,
        "asking_price_opportunity": qrow.get("asking_price_opportunity"),
