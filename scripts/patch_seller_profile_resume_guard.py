...
elif 'checkpointen är sparad' not in text:
    raise SystemExit('partial inventory status block not found')

# Do not show a fake provisional ranking when an interrupted fetch yielded zero rows.
...
print('patched Seller Top 5 interrupted-profile resume guard')
